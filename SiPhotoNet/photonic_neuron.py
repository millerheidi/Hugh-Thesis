...
class neuron:
    ...
    def __init__(self, weights, wavelength, net_wavelengths = [], mrr_radius = 6e-5, a = 0.95, r1 = 0.707, r2 = 0.707):
        """
    ...
    def detuneByWavelength(self, wavelength, n_0 = np.sqrt(12), i_mod = 0.0, coeff_mod = 10, i_heater = 0.0, coeff = 5e2):
        """
